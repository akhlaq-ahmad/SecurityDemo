...
public class CorsConfiguration {
	...
	public String checkOrigin(String requestOrigin) {
		...
		if (CorsUtils.isEmpty(this.allowedOrigins)) {
			return null;
		}
	...
	public List<HttpMethod> checkHttpMethod(HttpMethod requestMethod) {
		...
		for (String method : allowedMethods) {
			if (CorsUtils.matches(requestMethod, method)) {
				allowed = true;
			}
			HttpMethod resolved = CorsUtils.resolve(method);
			if (resolved != null) {
				result.add(resolved);
			}
		}
	...
	public List<String> checkHeaders(List<String> requestHeaders) {
		...
		if (CorsUtils.isEmpty(this.allowedHeaders)) {
			return null;
		}
